...
class BackController extends AbstractController
{
    ...
    #[Route('back/{id_res}', name: 'app_back_show', methods: ['GET'])]
    ...
    #[Route('back/{id_res}/edit', name: 'app_back_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{id_res}', name: 'app_back_delete', methods: ['POST'])]
    ...
    {
        $id_res = $request->query->get('id');
        $reservation = $reservationRepository->find($id_res);
    ...
    {
        $id_ticket = $request->query->get('id');
        $ticket = $ticketRepository->find($id_ticket);
    ...
    #[Route('/back/{id_res}/pdf', name: 'generate_pdf')]
    public function generatePdfAction($id_res , ReservationRepository $reservationRepository) : Response
    {
